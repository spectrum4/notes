...
// This program's data (homer_width, homer_height, homer) was extracted from:
// https://github.com/bztsrc/raspi3-tutorial/blob/3ab9e5a531576344c23751cfc8a56bfe0691ed9f/09_framebuffer/homer.h
// It loads this data and writes it as a png file to disk.
func main() {
	...
	for y := 0; y < homer_height; y++ {
		for x := 0; x < homer_width; x++ {
			startChar := (x + y*homer_width) * 4
			data := []byte(all[startChar : startChar+4])
			// 00000011
			// 11112222
			// 22333333
			...
			C := ((g & 0xf) << 2) | (b >> 6)
			D := b & 0x3f
			rebuilt := []byte{A + 33, B + 33, C + 33, D + 33}
